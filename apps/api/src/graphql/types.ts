...
export type BatchOperationResult = {
    ...
    /** Optional list of human-readable error messages when one or more items failed. */
    errors?: Maybe<Array<Scalars["String"]["output"]>>;
    /** Number of requested items that could not be processed (e.g. not found or unauthorized). */
    failedCount: Scalars["Int"]["output"];
    /** Number of items successfully processed. May be less than the number of requested items. */
    processedCount: Scalars["Int"]["output"];
    /** True when all requested items were processed successfully (i.e. failedCount is 0). */
    success: Scalars["Boolean"]["output"];
};
...
export type Mutation = {
     ...
     *
     * Items that are not found or not owned by the current user are reported as failures.
     * This operation may partially succeed.
     */
    batchDeleteItems: BatchOperationResult;
    /**
     * Move multiple wishlist items to a category.
     *
     * Items that are not found or not owned by the current user are reported as failures.
     * This operation may partially succeed.
     */
...
export type MutationBatchMoveItemsArgs = {
...
export type BatchOperationResultResolvers<
    ContextType = GraphQLContext,
    ParentType extends
        ResolversParentTypes["BatchOperationResult"] = ResolversParentTypes["BatchOperationResult"],
> = ResolversObject<{
    errors?: Resolver<
...
> = ResolversObject<{
    ...
    >;
    batchDeleteItems?: Resolver<
        ResolversTypes["BatchOperationResult"],
        ParentType,
        ContextType,
        RequireFields<MutationBatchDeleteItemsArgs, "input">
    >;
    batchMoveItems?: Resolver<
        ResolversTypes["BatchOperationResult"],
        ParentType,
        ContextType,
        RequireFields<MutationBatchMoveItemsArgs, "input">
    >;
