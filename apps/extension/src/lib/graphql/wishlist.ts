/**
 * Extension wishlist operations
 * Uses shared query strings and types from @repo/common with extension-specific client
 */
...
export async function updateItem(
  ...
  const data = await graphqlRequest<{
    updateItem: import("@repo/common/graphql/types").GraphQLWishlistItem | null;
